...
function RecentPosts(props) {
    ...
    const emptyRows =
        page > 0 ? Math.max(0, (1 + page) * rowsPerPage - props.post.length) : 0;
    ...
    return (
        <>
            {
                props.post.length === 0 ? `No posts yet :(` :
                    <TableContainer>
                        <Table sx={{ width: 800 }}>
                            <TableHead>
                                <TableRow>
                            ...
                            <TableBody>
                                {(rowsPerPage > 0
                                    ? props.post.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                    : props.post
                                ).map((row) => (
                                    <TableRow
                                        key={row.posts_id}
